...
public class TbpatientHepatitisCpositiveCalculation extends AbstractPatientCalculation {
	@Override
	public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> stringObjectMap, PatientCalculationContext context) {
		...
		Concept hepatitisc=  Dictionary.getConcept(Dictionary.HEPATITIS_C);
