...
public class TbpatientwithTransferredInCalculation extends AbstractPatientCalculation{
	@Override
	...
	{ 	
		...
		for (Integer ptId : cohort) {
			...
			ret.put(ptId, new BooleanResult(ontransferIn , this, context));
		}
		return ret;
	}
